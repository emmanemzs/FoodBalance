<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Snacks.aspx.cs" Inherits="Proj1.Snacks" %>
                 ...
                 <div class="meal-builder-section">
                  ...
                  <div class="meal-builder-left">
                    ...
                    <div class="food-grid"> <!-- all food options and buttons -->
                        <asp:Button ID="Button2" runat="server" Text="Protein Bar - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        <asp:Button ID="Button3" runat="server" Text="Yogurt - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        <asp:Button ID="Button4" runat="server" Text="Granola - 0" CssClass="food-buttonG" OnClick="Add_Food" />
                        <asp:Button ID="Button5" runat="server" Text="Cottage Cheese - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        ...
                        <asp:Button ID="Button10" runat="server" Text="Tomatos - 0" CssClass="food-buttonV" OnClick="Add_Food" />
