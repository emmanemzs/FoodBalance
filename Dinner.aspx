<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dinner.aspx.cs" Inherits="Proj1.Dinner" %>
                 ...
                 <div class="meal-builder-section">
                  ...
                  <div class="meal-builder-left">
                    ...
                    <div class="food-grid"> <!-- all food options and buttons -->
                        <asp:Button ID="Button2" runat="server" Text="Steak - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        <asp:Button ID="Button3" runat="server" Text="Salmon - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        <asp:Button ID="Button4" runat="server" Text="Roll - 0" CssClass="food-buttonG" OnClick="Add_Food" />
                        <asp:Button ID="Button5" runat="server" Text="Beef - 0" CssClass="food-buttonP" OnClick="Add_Food" />
                        <asp:Button ID="Button6" runat="server" Text="Tortilla - 0" CssClass="food-buttonG" OnClick="Add_Food" />
                        <asp:Button ID="Button7" runat="server" Text="Blackberries - 0" CssClass="food-buttonF" OnClick="Add_Food" />
                        <asp:Button ID="Button8" runat="server" Text="Avacado - 0" CssClass="food-buttonF" OnClick="Add_Food" />
                        <asp:Button ID="Button9" runat="server" Text="Peach - 0" CssClass="food-buttonF" OnClick="Add_Food" />
                        <asp:Button ID="Button10" runat="server" Text="Potatoes - 0" CssClass="food-buttonV" OnClick="Add_Food" />
                        <asp:Button ID="Button11" runat="server" Text="Peas - 0" CssClass="food-buttonV" OnClick="Add_Food" />
